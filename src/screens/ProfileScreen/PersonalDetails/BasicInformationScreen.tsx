...
const BasicInformationScreen: React.FC<{ initialValues: any; updateValues: (updatedValues: any) => void }> = ({ initialValues, updateValues }) => {
      ...
      <View style={styles.body}>
        ...
        <View style={styles.container}>
          ...
          <DropDownPicker
            ...
            items={DEFAULT_VALUES.genderItems}
          ...
          <DropDownPicker
            ...
            items={DEFAULT_VALUES.nationalityItems}
            value={initialValues?.nationality?.toLowerCase()}
          ...
          <DropDownPicker
            ...
            items={DEFAULT_VALUES.ethnicityItems}
          ...
          <DropDownPicker
            ...
            items={DEFAULT_VALUES.militaryItems}
          ...
          <DropDownPicker
            ...
            items={DEFAULT_VALUES.workplacePreferenceItems}
